...
class MagentoBinding(models.AbstractModel):
    ...
    All the models used as bindings between external Odoo and OpenERP
    (``odoo.res.partner``, ``odoo.product.product``, ...) should
    ``_inherit`` it.
    """
    _name = 'odoo.binding'
    _inherit = 'external.binding'
    _description = 'External Odoo Binding (abstract)'
    ...
    odoo_id = fields.Char(string='ID on External Odoo')

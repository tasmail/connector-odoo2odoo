...
from .unit.binder import OdooBinder

unwrap_binding = functools.partial(related_action.unwrap_binding,
                                   binder_class=OdooBinder)


def link(session, job, backend_id_pos=2, odoo_id_pos=3):
